...
export const Button = ({
  ...
  const baseStyles =
    "relative inline-flex items-center justify-center text-center fit-content whitespace-nowrap px-12 py-3 text-md font-large transition-colors duration-200 overflow-hidden group rounded-full";
