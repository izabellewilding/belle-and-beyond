...
export const About = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full xl:w-[45%] h-[50vh] xl:h-screen flex items-center justify-center xl:justify-end px-6 pt-12 pb-8 xl:px-0 xl:pt-0 xl:pb-0 xl:pr-10 overflow-visible z-20">
        <motion.div
      ...
      <div className="relative w-full max-w-[700px] xl:max-w-none xl:w-[55%] h-auto xl:h-screen flex items-center justify-center bg-[#ffeced] px-6 md:px-10 xl:pl-10 xl:-ml-6 xl:pr-24 pt-6 pb-20 xl:pt-0 xl:pb-0 xl:mx-0 mx-auto">
        <motion.div
          initial={{ opacity: 0, x: 50 }}
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: true }}
        ...
        >
          {/* Main Heading */}
          <h2 className="pt-10 md:pt-0 text-2xl md:text-3xl lg:text-4xl font-sans font-bold text-darkText leading-tight pb-4 md:pb-8">
