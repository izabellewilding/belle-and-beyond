...
export const RecentPosts = () => {
  ...
  return (
    <section id="news" className="w-full relative z-20 bg-[#faf7fa]">
      {/* Full width wave at the top */}
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 1440 100"
        className="absolute top-0 left-0 w-full block h-[100px] md:h-[80px]"
      ...
      >
        <path
          fill="#faf7fa"
          d="M0,25 C80,25 180,100 450,100 C650,100 750,0 1440,0 L1440,100 L0,100 Z"
        />
      </svg>

      {/* Full width content */}
      <div className="w-full px-4 md:px-8 lg:px-12 xl:px-16 pt-8 pb-8 md:pt-12 md:pb-16 lg:pt-16 lg:pb-16">
        {loading && (
